...
<section class="h-min-screen bg-gray-50 dark:bg-gray-900">
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto">
        ...
        <div class="w-1/2 bg-white rounded-lg shadow dark:border md:mt-0 dark:bg-gray-800 dark:border-gray-700">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="${pageContext.request.contextPath}/login" method="post">
                    <div>
                    ...
                    <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                        Don’t have an account yet? <a href="${pageContext.request.contextPath}/register" class="font-medium text-primary-600 hover:underline dark:text-white">Sign up</a>
                    </p>
                </form>
            </div>
        </div>
